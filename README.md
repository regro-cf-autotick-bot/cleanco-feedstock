...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cleanco-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14206&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cleanco-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cleanco` can be installed with:

```
conda install cleanco
```

It is possible to list all of the versions of `cleanco` available on your platform with:
